...
export const coreIntelligenceBranches = [
...
export const perceptionBranches = [
...
export const emotionalBranches = [
...
export const metaCognitionBranches = [
...
export function getBranchesByDomain(domain) {
    return allBranches.filter(b => b.domain === domain);
}
export function getBranchesByType(type) {
    return allBranches.filter(b => b.type === type);
}
export function getActiveBranches(threshold = 0.5) {
