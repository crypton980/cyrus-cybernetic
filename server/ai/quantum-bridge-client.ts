...
const QUANTUM_BRIDGE_URL = process.env.QUANTUM_BRIDGE_URL || 'http://127.0.0.1:5001';
  ...
  async checkHealth(): Promise<boolean> {
    ...
    try {
      ...
      if (response.ok) {
        ...
        this.nexusAvailable = (data as any).nexus_available || false;
        this.nexusActive = (data as any).nexus_active || false;
      } else {
