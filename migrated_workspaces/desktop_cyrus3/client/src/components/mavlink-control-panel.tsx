...
export function MAVLinkControlPanel() {
  ...
  const connectMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/connect", {
        connectionId: `mavlink-${Date.now()}`,
        type: config.type,
        host: config.host,
        port: config.port,
  ...
  const disconnectMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/disconnect", { connectionId });
      return res.json();
    },
    onSuccess: () => {
  ...
  const armMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/arm", { connectionId });
      return res.json();
    }
  });
  ...
  const disarmMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/disarm", { connectionId });
      return res.json();
    }
  });
  ...
  const takeoffMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/takeoff", { 
        connectionId, 
        altitude: parseFloat(takeoffAlt) 
      });
      return res.json();
    }
  });
  ...
  const landMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/land", { connectionId });
      return res.json();
    }
  });
  ...
  const rtlMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/rtl", { connectionId });
      return res.json();
    }
  });
  ...
  const gotoMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/goto", { 
        connectionId,
  ...
  const setModeMutation = useMutation({
    mutationFn: async () => {
      const res = await apiRequest("POST", "/api/cyrus/mavlink/setmode", { 
        connectionId,
        mode: selectedMode
      });
      return res.json();
  ...
  useEffect(() => {
    ...
    const pollTelemetry = async () => {
      try {
        const res = await fetch(`/api/cyrus/mavlink/telemetry/${connectionId}`);
    ...
    const pollDiscovered = async () => {
      try {
        const res = await fetch(`/api/cyrus/mavlink/discovered/${connectionId}`);
        const data = await res.json();
        if (data.drones) {
          setDiscoveredDrones(data.drones);
        }
      } catch (error) {
        console.error("Discovered poll error:", error);
      }
    };
