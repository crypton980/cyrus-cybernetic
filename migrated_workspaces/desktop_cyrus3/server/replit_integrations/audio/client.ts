 ...
 * Uses gpt-audio-mini model via Replit AI Integrations.
 * Default voice is "shimmer" for a sweet, gentle female voice.
 */
...
export async function* voiceChatWithTextModel(
  ...
  const {
    voice = "shimmer",
    inputFormat = "wav",
    systemPrompt = "You are CYRUS, a warm and helpful AI assistant with a gentle, caring personality. Speak naturally and conversationally like a kind friend. Be supportive, empathetic, and encouraging in your responses.",
    chatHistory = [],
